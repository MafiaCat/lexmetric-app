...
def seed_db(custom_db=None):
    # Remove existing db to force recreation with new schema
    if os.path.exists("lexmetric.db") and custom_db is None:
    ...
    db = custom_db if custom_db else SessionLocal()
    ...
    lawyers_data = [
        Lawyer(first_name="Jean", last_name="Dupont", bar_association="Paris", 
               ...
               in_network=True, average_hourly_rate=250.0, law_firm_id=firm1.id, status="approved"),
        ...
        Lawyer(first_name="Marie", last_name="Curie", bar_association="Lyon", 
               ...
               in_network=False, average_hourly_rate=300.0, law_firm_id=firm2.id, status="approved"),
        ...
        Lawyer(first_name="Paul", last_name="Lefebvre", bar_association="Marseille", 
               ...
               in_network=True, average_hourly_rate=180.0, law_firm_id=None, status="approved"),
        ...
        Lawyer(first_name="Sophie", last_name="Martin", bar_association="Bordeaux", 
               ...
               in_network=True, average_hourly_rate=350.0, law_firm_id=firm3.id, status="approved"),
        ...
        Lawyer(first_name="Lucas", last_name="Bernard", bar_association="Paris", 
               ...
               in_network=False, average_hourly_rate=220.0, law_firm_id=firm1.id, status="approved"),
        ...
        Lawyer(first_name="Emma", last_name="Petit", bar_association="Lille", 
               ...
               in_network=True, average_hourly_rate=150.0, law_firm_id=firm2.id, status="approved"),
    ]
